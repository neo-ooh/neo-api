 ...
 *
 * @neo/api - StoreFormatCropFrameRequest.php
 */
...
class StoreFormatCropFrameRequest extends FormRequest {
    public function rules(): array {
        return [
            "display_type_frame_id" => ["required", new Exists(DisplayTypeFrame::class, "id")],
