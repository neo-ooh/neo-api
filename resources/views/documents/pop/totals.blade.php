<table class="summary-totals-table" autosize="1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ formatCurrency($contract["current_guaranteed_value"])  }}</td>
        </tr>
        @if(count($bonusReservations) > 0)
            <tr>
                ...
                <td>{{ formatCurrency($contract["current_bonus_value"])  }}</td>
            </tr>
        @endif
        @if(count($buaReservations) > 0)
            <tr>
                ...
                <td>{{ formatCurrency($contract["current_bua_value"])  }}</td>
            </tr>
        @endif
    </tbody>
    <tfoot>
        <tr>
            ...
            <td>{{ formatCurrency($contract["current_value"]) }}</td>
        </tr>
    </tfoot>
</table>
