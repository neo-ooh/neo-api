 ...
 *
 * @neo/api - ImportMobileMallPropertiesCommand.php
 */
...
class ImportMobileMallPropertiesCommand extends Command {
	protected $signature = 'mobile:import-malls {--network=} {--parent=} {--inventory=} {file}';
