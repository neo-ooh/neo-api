...
namespace Neo\Modules\Properties\Jobs\Demographics;
...
use Neo\Modules\Properties\Jobs\Demographics\FilesParsers\EnvironicsDefaultParser;
use Neo\Modules\Properties\Jobs\Demographics\FilesParsers\EnvironicsPrizmParser;
use Neo\Modules\Properties\Models\DemographicValue;
use Neo\Modules\Properties\Models\DemographicVariable;

/**
 * This job takes the path a file storing demographic values for a property, and imports them using the parser specified by the
 * `format` variable.
 */
